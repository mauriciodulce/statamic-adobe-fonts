...
return [
    ...
    /*
     * Here you can register fonts to call from the @typekit Blade directive.
     * The typekit:fetch command will prefetch these fonts.
     */
    'fonts' => [
        'default' => 'https://use.typekit.net/[PROJECT_ID].css',
    ],
    ...
    /*
     * This user agent will be used to request the stylesheet from Adobe Typekit Fonts.
